...
clas1 = [250,500,1000,1500,2000]
clas2 = ['250-500','500-1000','1000-1500','1500-2000']
Resultado = dict([((a,b),'') for a in clas1 for b in clas2])
inconsistencia = 'O algoritmo encontrou uma inconsistência na classificação\nPor favor, tente denovo.'
for i in [(250, '500-1000'),(250,'1000-1500'),(250, '1500-2000'),(500, '1000-1500'),(500, '1500-2000'),
          (500, '1500-2000'),(1000, '250-500'),(1000, '1500-2000'),(1500, '250-500'),(1500, '500-1000'),
          (2000, '250-500'),(2000, '500-1000'),(2000, '1000-1500')]:
    Resultado[i]=inconsistencia
print('Classe verdadeira: '+ str(concentracao))
print('Classificação 1: '+str(classe1[0]))
print('Classificação 2: '+str(classe2[0]))
print(Resultado[(classe1[0],classe2[0])])
